...
# Allow running as `python apps/network_sim.py` from repository root.
...
def parse_args(argv):
    p = argparse.ArgumentParser(
        description=(
            ...
            "For AI-Factory SU (including bucket params like num_buckets), use apps/ai_factory_sim.py + YAML."
        )
    )
